...
#Data Collection
oghost=$(hostname)
ogLAN=$(ip a s $(ip a |awk '/: e/{gsub(/:/,"");print $2}')|awk '/inet /{gsub(/\/.*/,"");print $2}')
ogLANH=$(getent hosts $(ip a s $(ip a |awk '/: e/{gsub(/:/,"");print $2}')|awk '/inet /{gsub(/\/.*/,"");print $2}')| awk '{print $2}')
ogXIP=$(curl -s icanhazip.com)
ogXH=$(getent hosts $(curl -s icanhazip.com) | awk '{print $2}')

#output section
echo "Hostname: $oghost"
echo "LAN IP: $ogLAN"
echo "LAN Hostname: $ogLANH"
echo "External IP: $ogXIP"
echo "External Name: $ogXH"
...
routIP=$(route -n |awk ' FNR == 3 {print $2}')
routH=$(getent hosts $routIP | awk '{print $2}')

#output Task 2
echo "Router Address: $routIP"
echo "Router Hostname: $routH"
